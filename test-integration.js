 ...
 * Como o ambiente de teste não compila better-sqlite3, uso um shim de banco
 * em memória que replica EXATAMENTE a API pública do src/db.js. A lógica
 * testada (parser + responder + fluxo) é a mesma que roda em produção.
 */
